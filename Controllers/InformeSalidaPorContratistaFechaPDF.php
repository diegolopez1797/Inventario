...
class InformeSalidaPorContratistaFechaPDF extends FPDF
{
// Cabecera de página
function Header()
{
...
$informeGeneral = $_SESSION['informeGeneralSalidaPorContratistaFecha'];

   
$pdf = new InformeSalidaPorContratistaFechaPDF();
