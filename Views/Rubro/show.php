			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td><a id="boton-eliminar" class="btn btn-danger" href="?controller=Rubro&&action=delete&&id=<?php echo $rubro->getId(); ?>"><span class="glyphicon glyphicon-trash"> </span> Eliminar</a></td>
					</tr>
					<?php } ?>
				</tbody>
			</thead>
